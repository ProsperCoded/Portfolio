...
function Main() {
  return (
    <div className="main curveGradient">
      {/* <BlobAnimation /> */}
      <div className="main__content">
        ...
        <p className="main__description">
          ...
          aesthetics and a dedication to user-centric and SEO-friendly design, I
          specialize in creating websites that not only look good but also
          ...
          websites, I am committed to delivering digital solutions that leave a
          lasting impact.
        </p>
      </div>
